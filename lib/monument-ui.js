...
exports.Element = function (_a) {
    ...
    return (react_1.default.createElement(Element_1.Base, __assign({ ref: el, depth: depth, layers: layers, animate: animate, clickable: clickEvent, hoverable: hoverEvent, touchable: touchEvent }, props), children));
};
...
exports.Text = function (_a) {
    ...
    return (react_1.default.createElement(Text_1.Base, __assign({ depth: depth, layers: layers }, props), children));
};
