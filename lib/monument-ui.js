...
var Element = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.div(_templateObject(), function (_ref) {
  var _ref$perspective = _ref.perspective,
    ...
    y: 5
      ...
      shadow = _ref$shadow === void 0 ? '10px 10px 20px #0005' : _ref$shadow,
  ...
  return "\n    transition: all 300ms ease;\n\n    &:not(:focus):not(:active) {\n      box-shadow: ".concat(Object(_layers__WEBPACK_IMPORTED_MODULE_1__["layers"])(perspective.x, perspective.y, color, shadow, colorify), ";\n    }\n\n    ").concat(hoverable && "\n      &:hover {\n        cursor: pointer;\n      }\n\n      &:not(:active):hover {\n        box-shadow: ".concat(Object(_layers__WEBPACK_IMPORTED_MODULE_1__["layers"])(perspective.x > 0 ? perspective.x + 6 : perspective.x - 6, perspective.y > 0 ? perspective.y + 6 : perspective.y - 6, color, shadow, colorify), ";\n\n        transform: translate(").concat(perspective.x > 0 ? -6 : 6, "px, ").concat(perspective.y > 0 ? -6 : 6, "px);\n      }\n    "), "\n\n    ").concat(clickable && "\n      &:focus,\n      &:active {\n        box-shadow: 0, 0, 0 rgba(0, 0, 0, 0);\n        transform: translate(".concat(perspective.x, "px, ").concat(perspective.y, "px);\n      }\n    "), "\n  ");
});
/*{
...
/* harmony import */ var _generateColors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generateColors */ "./src/generateColors.js");
