...
})(global, function(__WEBPACK_EXTERNAL_MODULE_rgbcolor__, __WEBPACK_EXTERNAL_MODULE_styled_components__, __WEBPACK_EXTERNAL_MODULE_to_px__) {
...
var layers = function layers(x, y, color, shadow, colorify) {
  var master, slave;
  x = typeof x === 'string' ? to_px__WEBPACK_IMPORTED_MODULE_0___default()(x) : x;
  y = typeof y === 'string' ? to_px__WEBPACK_IMPORTED_MODULE_0___default()(y) : y;
