...
var Element = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.div(_templateObject(), function (_ref) {
  ...
  return "\n    transition: all 300ms ease;\n\n    &:not(:focus):not(:active) {\n      box-shadow: ".concat(Object(_layers__WEBPACK_IMPORTED_MODULE_1__["layers"])(perspective.x, perspective.y, color), ";\n    }\n\n    ").concat(hoverable && "\n      &:hover {\n        cursor: pointer;\n      }\n\n      &:not(:active):hover {\n        box-shadow: ".concat(Object(_layers__WEBPACK_IMPORTED_MODULE_1__["layers"])(perspective.x > 0 ? perspective.x + 6 : perspective.x - 6, perspective.y > 0 ? perspective.y + 6 : perspective.y - 6, color), ";\n        \n        margin-left: ").concat(perspective.x > 0 ? -6 : 6, "px\n        margin-top: ").concat(perspective.y > 0 ? -6 : 6, "px;\n      }\n    "), "\n\n    ").concat(clickable && "\n      &:focus,\n      &:active {\n        box-shadow: 0, 0, 0 rgba(0, 0, 0, 0);\n        transform: translate(".concat(perspective.x, "px, ").concat(perspective.y, "px);\n      }\n    "), "\n  ");
});
/*&:not(:active):hover {
  box-shadow: ${layers(
