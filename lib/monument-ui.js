...
exports.Element = function (_a) {
    var color = _a.color, _b = _a.shadow, shadow = _b === void 0 ? '' : _b, _c = _a.colorify, colorify = _c === void 0 ? false : _c, _d = _a.perspective, perspective = _d === void 0 ? { x: 5, y: 5 } : _d, clickable = _a.clickable, hoverable = _a.hoverable, touchable = _a.touchable, props = __rest(_a, ["color", "shadow", "colorify", "perspective", "clickable", "hoverable", "touchable"]);
    ...
    var _g = react_1.useState(null), mode = _g[0], setMode = _g[1];
    var _h = react_1.useState(), clickEvent = _h[0], setClickEvent = _h[1];
    var _j = react_1.useState(), touchEvent = _j[0], setTouchEvent = _j[1];
    var _k = react_1.useState(), hoverEvent = _k[0], setHoverEvent = _k[1];
    var _l = react_1.useState({
        x: helpers_1.convertUnits(perspective.x),
        y: helpers_1.convertUnits(perspective.y)
    }), depth = _l[0], setDepth = _l[1];
    react_1.useEffect(function () {
        var generateLayers = function () {
            ...
            var extraX;
            var extraY;
            if ((mode === 'mousedown' && clickable === 'pull') ||
        ...
        generateLayers();
        el.current.addEventListener('mousedown', function () { return setMode('mousedown'); });
        el.current.addEventListener('mouseup', function () { return setMode(null); });
        el.current.addEventListener('mouseenter', function () { return setMode('mouseenter'); });
        el.current.addEventListener('mouseleave', function () { return setMode(null); });
        el.current.addEventListener('touchstart', function () { return setMode('touchstart'); });
        el.current.addEventListener('touchend', function () { return setMode(null); });
    ...
    return (react_1.default.createElement(Element_1.Base, __assign({ ref: el, depth: depth, layers: layers, animate: animate, clickable: clickEvent, hoverable: hoverEvent, touchable: touchEvent }, props)));
};
...
exports.Text = function (_a) {
    var color = _a.color, _b = _a.shadow, shadow = _b === void 0 ? '' : _b, _c = _a.colorify, colorify = _c === void 0 ? false : _c, _d = _a.perspective, perspective = _d === void 0 ? { x: 5, y: 5 } : _d, props = __rest(_a, ["color", "shadow", "colorify", "perspective"]);
    var _e = react_1.useState(''), layers = _e[0], setLayers = _e[1];
    var depth = {
        x: helpers_1.convertUnits(perspective.x),
        y: helpers_1.convertUnits(perspective.y)
    ...
    return react_1.default.createElement(Text_1.Base, __assign({ depth: depth, layers: layers }, props));
};
